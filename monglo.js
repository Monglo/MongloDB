...
require.register("collection.js", function(module, exports, require){
/*!
 * Monglo - collection
...
var EventEmitter = require('./events').EventEmitter
  ...
  , Modifier = require('./modify');

var Collection = module.exports = function Collection(db, collectionName, pkFactory, options) {
...
Collection.prototype.insert = function (doc,options,cb) {
  var self = this;
    ...
    if(cb) { cb(doc); }
     return (no_chain) ? self.docs[doc._id]: this;
};
  ...
  for (var id in self.docs) {
    ...
    if (selector_f(doc)) {
      ...
      if (!options.multi) {
        ...
        if(cb) { cb(self.docs[id]); }
        return (no_chain) ? self.docs[id]  : self;
      }
    }
  }
...
require.register("Cursor.js", function(module, exports, require){
var EventEmitter = require('./events').EventEmitter
  , ObjectId = require('./ObjectId')
  , utils = require('./utils')
  , Selector = require('./selector');

var Cursor = module.exports = function Cursor(db, collection, selector, fields, skip, limit,sort) {
  this.db = db;
...
require.register("Database.js", function(module, exports, require){
/*!
 * Monglo - database
 * Copyright (c) 2012 Christian Sullivan <cs@euforic.co>
 * MIT Licensed
...
require.register("diff.js", function(module, exports, require){
...
require.register("events.js", function(module, exports, require){
/**
 * Module exports.
 */
...
require.register("modify.js", function(module, exports, require){
/*!
 * Monglo - modify
 * Copyright(c) 2012 Christian Sullivan <cs@euforic.co>
 * MIT Licensed
...
Modifier._modify = function (doc, mod) {
  ...
  if (!is_modifier) {
    if (mod._id && doc._id !== mod._id) {
      utils._debug("_id ignored : Cannot change the _id of a document");
    }
    ...
    for (var op in mod) {
      var mod_func = Modifier._modifiers[op];
      if (!mod_func)
      ...
      for (var keypath in mod[op]) {
        ...
        var no_create = !!Modifier._noCreateModifiers[op];
        var forbid_array = (op === "$rename");
        var target = Modifier._findModTarget(new_doc, keyparts,
...
Modifier._findModTarget = function (doc, keyparts, no_create,
                                      forbid_array) {
...
Modifier._modifiers = {
    ...
    if (x === undefined)
      ...
      _.each(values, function (value) {
        for (var i = 0; i < x.length; i++)
          if (Modifier._f._equal(value, x[i]))
            return;
        x.push(value);
      });
    }
  ...
  $pull: function (target, field, arg) {
    ...
    if (x === undefined)
      ...
      if (typeof arg === "object" && !(arg instanceof Array)) {
        ...
        var match = Modifier._compileSelector(arg);
        for (var i = 0; i < x.length; i++)
          if (!match(x[i]))
            out.push(x[i])
      } else {
        for (var i = 0; i < x.length; i++)
          if (!Modifier._f._equal(x[i], arg))
            out.push(x[i]);
      }
      target[field] = out;
    }
    ...
    if (x === undefined)
      ...
      for (var i = 0; i < x.length; i++) {
        ...
        for (var j = 0; j < arg.length; j++) {
          if (Modifier._f._equal(x[i], arg[j])) {
            exclude = true;
            break;
          }
        }
  ...
  $rename: function (target, field, arg, keypath, doc) {
    ...
    var target2 = Modifier._findModTarget(doc, keyparts, false, true);
    if (target2 === null)
...
require.register("Monglo.js", function(module, exports, require){
...
require.register("ObjectId.js", function(module, exports, require){
/*!
 * Monglo - ObjectId
 * Copyright(c) 2012 Christian Sullivan <cs@euforic.co>
 * MIT Licensed
...
*/
var ObjectID = module.exports = function ObjectID(id, _hex) {
...
require.register("selector.js", function(module, exports, require){
...
require.register("sort.js", function(module, exports, require){
