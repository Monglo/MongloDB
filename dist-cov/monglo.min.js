...
Collection.prototype.find = (function () {
  ...
  _$jscoverage['monglo.min.js'][6]++;
  return options.ignore? cb? cb(doc): doc: (self.emit("insert", doc), this.db._executeCommand("insert", {conn: self.db, collection: self, doc: self.docs[doc._id]}), cb && cb(doc), this);
