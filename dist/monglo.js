...
require.register("MongloDB", function (exports, module) {

module.exports = require('MongloDB/lib/Monglo.js');
});

require.register("MongloDB/lib/Collection.js", function (exports, module) {
/*!
 * Monglo - collection
...
var EventEmitter = require('component~emitter@1.1.3')
  , ObjectId = require('MongloDB/lib/ObjectId.js');
...
require.register("MongloDB/lib/Cursor.js", function (exports, module) {
/*!
 * Monglo - cursor
 * Copyright (c) 2012 Christian Sullivan <cs@euforic.co>
 * MIT Licensed
...
var utils = require('MongloDB/lib/utils.js')
  , Collection = require('MongloDB/lib/Collection.js')
  , Selector = require('MongloDB/lib/selector.js');
...
require.register("MongloDB/lib/Monglo.js", function (exports, module) {
/*!
 * Monglo
 * Copyright (c) 2012 Christian Sullivan <cs@euforic.co>
 * MIT Licensed
...
var EventEmitter = require('component~emitter@1.1.3')
  , ObjectId = require('MongloDB/lib/ObjectId.js')
  , utils = require('MongloDB/lib/utils.js')
  , Collection = require('MongloDB/lib/Collection.js');


module.exports = Monglo;
...
require.register("MongloDB/lib/ObjectId.js", function (exports, module) {
/*!
 * Monglo - ObjectId
 * Copyright (c) 2012 Christian Sullivan <cs@euforic.co>
 * MIT Licensed
...
require.register("MongloDB/lib/selector.js", function (exports, module) {
/*!
 * Monglo - Selector
 * Copyright (c) 2012 Christian Sullivan <cs@euforic.co>
 * MIT Licensed
...
require.register("MongloDB/lib/utils.js", function (exports, module) {
/*!
 * Monglo - utils
 * Copyright (c) 2012 Christian Sullivan <cs@euforic.co>
 * MIT Licensed
...
if (typeof exports == "object") {
  module.exports = require("MongloDB");
} else if (typeof define == "function" && define.amd) {
  define("monglo", [], function(){ return require("MongloDB"); });
} else {
  (this || window)["monglo"] = require("MongloDB");
}
})()
